...
export class RegisterComponent implements OnInit {
  ...
  register() {
    ...
    this.firebase.register(this.newUserData.email, this.password, this.newUserData.displayName.trim().toLowerCase(), this.newUserData.dob, this.newUserData.country, this.newUserData.county);
  }
}